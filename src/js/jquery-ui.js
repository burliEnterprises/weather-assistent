                ...
                if (c.target) {
                    ...
                    if (!(this.running || !g.collapsible && f)) {
                        ...
                        h = {
                            ...
                            , newContent: f && g.collapsible ? b([]) : i
                            , oldContent: d
                        };
    ...
    b.extend(f.prototype, {
        ...
        , _generateMonthYearHeader: function (a, d, h, i, j, n, q, l) {
            ...
            if (n || !m) p += '<span class="ui-datepicker-year">' + h + "</span>";
                ...
                for (a.yearshtml += '<select class="ui-datepicker-year" onchange="DP_jQuery_' + e + ".datepicker._selectMonthYear('#" + a.id + "', this, 'Y');\" onclick=\"DP_jQuery_" + e + ".datepicker._clickMonthYear('#" + a.id + "');\">"; d <= l; d++) a.yearshtml += '<option value="' + d + '"' + (d == h ? ' selected="selected"' : "") + ">" + d + "</option>";
                a.yearshtml += "</select>";
...
(function (b, c) {
    ...
    b.widget("ui.dialog", {
        ...
        , _size: function () {
            var e = this.options
                , a, d, h = this.uiDialog.is(":visible");
